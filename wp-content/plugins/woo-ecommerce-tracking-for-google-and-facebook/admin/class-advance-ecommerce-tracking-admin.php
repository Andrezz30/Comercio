...
class Advance_Ecommerce_Tracking_Admin {
    ...
    public function aet_enqueue_styles( $hook ) {
         ...
         * class.
         */
        if ( false !== strpos( $hook, 'dotstore-plugins_page_aet' ) || false !== strpos( $hook, 'admin_page_aet-et' ) || false !== strpos( $hook, 'toplevel_page_aet-et-settings' ) ) {
            wp_enqueue_style(
                $this->plugin_name,
    ...
    public function aet_enqueue_scripts( $hook ) {
         ...
         * class.
         */
        if ( false !== strpos( $hook, 'dotstore-plugins_page_aet' ) || false !== strpos( $hook, 'aet-et-settings-account' ) || false !== strpos( $hook, 'toplevel_page_aet-et-settings' ) ) {
            global $wp;
            ...
            wp_localize_script( $this->plugin_name, 'aet_vars', array(
                ...
                'dpb_api_url'             => AET_PROMOTIONAL_BANNER_API_URL,
            ...
            'main_menu' => array(
                'pro_menu'  => array(
                    ...
                    'aet-get-started' => array(
                        'menu_title' => __( 'Settings', 'advance-ecommerce-tracking' ),
    ...
    public function aet_get_promotional_bar( $plugin_slug = '' ) {
        $promotional_bar_upi_url = AET_PROMOTIONAL_BANNER_API_URL . 'wp-json/dpb-promotional-banner/v2/dpb-promotional-banner?' . wp_rand();
