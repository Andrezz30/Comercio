	...
	<div class="waet-section-left">
		<div class="waet-table res-cl">
			...
			if ( 'on' === $custom_event ) {
				...
				$btn_post         = filter_input( INPUT_POST, 'custom_event_setting', FILTER_SANITIZE_FULL_SPECIAL_CHARS );
				$aet_admin_object = new Advance_Ecommerce_Tracking_Admin( '', '' );
				$submit_text      = esc_html__( 'Submit', 'advance-ecommerce-tracking' );
				if ( isset( $btn_post ) ) {
					$post_wpnonce         = filter_input( INPUT_POST, 'aet_cat_conditions_save', FILTER_SANITIZE_FULL_SPECIAL_CHARS );
				...
				if ( 'add' === $get_action || 'edit' === $get_action ) {
					?>
					<h2><?php esc_html_e( 'Custom Event Configuration', 'advance-ecommerce-tracking' ); ?>
							...
							<div class="general_setting" id="custom_event_general_setting">
								<table class="form-table table-outer">
									...
									<tr valign="top">
										...
										<td class="forminp">
											<input type="text" name="selector_attr" id="selector_attr" placeholder="Enter selector" value="<?php echo esc_attr( $selector_attr ); ?>" required/>
									...
									<tr valign="top">
										...
										<td class="forminp">
											<input type="text" name="event_category" id="event_category" placeholder="Enter Event Category" value="<?php echo esc_attr( $event_category ); ?>" required/>
											<span class="advance_ecommerce_tracking_tab_description"></span>
											<p class="description" style="display:none;">
									...
									<tr valign="top">
										...
										<td class="forminp">
											<input type="text" name="event_action" id="event_action" placeholder="Enter Event Action" value="<?php echo esc_attr( $event_value ); ?>" required/>
											<span class="advance_ecommerce_tracking_tab_description"></span>
											<p class="description" style="display:none;">
									...
									<tr valign="top">
										...
										<td class="forminp">
											<input type="text" name="event_label" id="event_label" placeholder="Enter Event Label" value="<?php echo esc_attr( $event_label ); ?>" required/>
											<span class="advance_ecommerce_tracking_tab_description"></span>
											<p class="description" style="display:none;">
									...
									<tr valign="top">
										...
										<td class="forminp">
											<input type="text" name="event_value" id="event_value" placeholder="Enter Event Value" value="<?php echo esc_attr( $event_value ); ?>"/>
											<span class="advance_ecommerce_tracking_tab_description"></span>
											<p class="description" style="display:none;">
					...
					<div class="product_header_title">
						<h2>
							...
							<a class="wp-core-ui button-primary msbb-cls" href="<?php echo esc_url( $add_event_url ); ?>">
								<?php esc_html_e( 'Add New Event', 'advance-ecommerce-tracking' ); ?>
							</a>
							<a id="delete-custom-event" class="wp-core-ui button-secondary msbb-cls" data-attr="Analytics">
