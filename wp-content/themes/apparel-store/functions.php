...
if ( !function_exists( 'apparel_store_parent_css' ) ):
    function apparel_store_parent_css() {
        ...
        $custom_css = ':root {--primary-color:'.esc_attr( get_theme_mod('__primary_color','#6c757d') ).'!important; --secondary-color: '.esc_attr( get_theme_mod('__secondary_color','#ed1c24') ).'!important;--nav-color-h:'.esc_attr( get_theme_mod('__secondary_color','#ed1c24') ).'!important;--nav-sub-color:'.esc_attr( get_theme_mod('__secondary_color','#ed1c24') ).'!important;--nav-sub-bg-h:'.esc_attr( get_theme_mod('__secondary_color','#ed1c24') ).'!important;--nav-sub-color-h:#fff}';
...
if( !function_exists('apparel_store_theme_options') ):
    ...
    */
    function apparel_store_theme_options( $defaults ){
        ...
        $defaults['__secondary_color']              = '#0068D0';
