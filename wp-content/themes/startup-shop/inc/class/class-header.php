            ...
            <div class="container">
            	<div class="d-flex">
            		...
            		<?php if( function_exists('is_woocommerce') ){ ?>
                        <div class="menu-category-list">
                            <span class="click-event" tabindex="0" autofocus="true">
                                ...
                                <?php echo esc_html__( 'Shop By Department', 'startup-shop' );?>
                            </span>
							<?php 
								$widgets_args = array(
									'title' => '',
								...
								the_widget( 'WC_Widget_Product_Categories', $widgets_args);
                            ?>
                        </div> 
                       <?php } ?>
                    ...
                    <div class="col-md-3 text-right">
                    	...
                    	echo wp_kses( $this->get_site_header_icon(), $this->alowed_tags() ); ?></div>
                </div>
            </div>
